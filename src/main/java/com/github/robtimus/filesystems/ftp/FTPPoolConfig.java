...
public final class FTPPoolConfig {
    ...
    /**
     * Returns a default {@link FTPPoolConfig} object. This has the same configuration as an object returned by {@code custom().build()}.
     *
     * @return A default {@link FTPPoolConfig} object.
     * @see #custom()
     */
    ...
    /**
     * Returns a new builder for creating {@link FTPPoolConfig} objects.
     *
     * @return A new builder for creating {@link FTPPoolConfig} objects.
     */
    ...
    /**
     * A builder for {@link FTPPoolConfig} objects.
     *
     * @author Rob Spoor
     * @since 3.0
     */
    public static final class Builder {
        ...
        /**
         * Creates a new {@link FTPPoolConfig} object based on the settings of this builder.
         *
         * @return The created {@link FTPPoolConfig} object.
         */
        public FTPPoolConfig build() {
            return new FTPPoolConfig(this);
        }
    }
}
