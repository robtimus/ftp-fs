...
public class FTPLoggerTest {
    ...
    public FTPLoggerTest(@SuppressWarnings("unused") String testName, Method method) {
        this.method = method;
    }
    ...
    private static void collectParameters(List<Object[]> parameters) {
        for (Method method : FTPLogger.class.getMethods()) {
            if (method.getDeclaringClass() != Object.class && !"addCommandListener".equals(method.getName())) {
